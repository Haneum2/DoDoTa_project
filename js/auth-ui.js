    ...
    modal.innerHTML = `
        <div class="auth-modal-box">
            ...
            <div id="auth-form-view">
                ...
                <label id="auto-login-label" class="auto-login-label">
                    <input type="checkbox" id="auto-login-checkbox" checked> 자동 로그인
                </label>
...
function switchAuthTab(tab) {
    ...
    document.getElementById('auto-login-label').style.display = tab === 'login' ? 'flex' : 'none';
...
async function submitAuthForm() {
    ...
    try {
        if (currentAuthTab === 'login') {
            const autoLogin = document.getElementById('auto-login-checkbox')?.checked ?? true;
            await auth.setPersistence(
                autoLogin ? firebase.auth.Auth.Persistence.LOCAL
